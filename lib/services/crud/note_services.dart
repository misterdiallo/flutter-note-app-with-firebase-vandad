...
//   //! _ensure Db Is Oopen
//   Future<void> _ensureDbIsOopen() async {
//     try {
//       await openDb();
...
//       return user;
//     } on CouldNotFindUser {
//       final createdUser = await createUser(email: email.toLowerCase());
//       if (setAsCurrentUser) {
//         _user = createdUser;
//       }
//       return createdUser;
...
//     } else {
//       final nota = DatabaseNote.fromRow(note.first);
